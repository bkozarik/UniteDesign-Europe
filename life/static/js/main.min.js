            ...
            if (!r && (T(e), (e = e || C), E)) {
                ...
                if (d.qsa && !N[t + " "] && (!v || !v.test(t)) && (1 !== p || "object" !== e.nodeName.toLowerCase())) {
                    if (((c = t), (f = e), 1 === p && (U.test(t) || z.test(t)))) {
                        for (((f = (ee.test(t) && ye(e.parentNode)) || e) === e && d.scope) || ((s = e.getAttribute("id")) ? (s = s.replace(re, ie)) : e.setAttribute("id", (s = S))), o = (l = h(t)).length; o--; )
        ...
        S.fn.extend({
            ...
            toggleClass: function (i, t) {
                ...
                return "boolean" == typeof t && a
                    ...
                    : this.each(function () {
                          var e, t, n, r;
                          if (a) for (t = 0, n = S(this), r = mt(i); (e = r[t++]); ) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
...
($jscomp.scope = {}),
    ...
    ($jscomp.polyfill = function (a, n, f, p) {
        if (n) {
            for (f = $jscomp.global, a = a.split("."), p = 0; p < a.length - 1; p++) {
                var k = a[p];
                k in f || (f[k] = {}), (f = f[k]);
            }
            (n = n((p = f[(a = a[a.length - 1])]))) != p && null != n && $jscomp.defineProperty(f, a, { configurable: !0, writable: !0, value: n });
        }
    }),
    $jscomp.polyfill(
        ...
        function (a) {
            var n = function (b, d, e) {
                var c = {
                    ...
                    getCaret: function () {
                        try {
                            ...
                            if (h && -1 === navigator.appVersion.indexOf("MSIE 10")) {
                                var e = h.createRange();
                                e.moveStart("character", -c.val().length), (a = e.text.length);
                            } else (d || "0" === d) && (a = d);
                            return a;
                        } catch (C) {}
                    },
                        ...
                        try {
                            if (b.is(":focus")) {
                                ...
                                if (c.setSelectionRange) c.setSelectionRange(a, a);
                                    ...
                                    g.collapse(!0), g.moveEnd("character", a), g.moveStart("character", a), g.select();
                                }
                            }
                        } catch (B) {}
                    },
                    ...
                    getRegexMask: function () {
                        for (var b, c, e, t, a = [], f = 0; f < d.length; f++)
                        ...
                        return (a = a.join("")), t && (a = a.replace(new RegExp("(" + t.digit + "(.*" + t.digit + ")?)"), "($1)?").replace(new RegExp(t.digit, "g"), t.pattern)), new RegExp(a);
                    },
                        ...
                        for (; A(); ) {
                            ...
                            q
                                ? (v.match(q.pattern)
                                  ...
                                  (n += m))
                                : (a || h[r](y), v === y ? (b.push(n), (n += m)) : ((z = y), b.push(n + w), w++), (g += m));
                        }
                        return (a = d.charAt(x)), k !== p + 1 || l.translation[a] || h.push(a), (h = h.join("")), c.mapMaskdigitPositions(h, b, p), h;
                    },
                    mapMaskdigitPositions: function (a, b, d) {
                        for (a = e.reverse ? a.length - d : 0, c.maskDigitPosMap = {}, d = 0; d < b.length; d++) c.maskDigitPosMap[b[d] + a] = 1;
                    },
                ...
                (d = "function" == typeof d ? d(c.val(), void 0, b, e) : d),
                    ...
                    (l.remove = function () {
                        var a = c.getCaret();
                        return l.options.placeholder && b.removeAttr("placeholder"), b.data("mask-maxlength") && b.removeAttr("maxlength"), c.destroyEvents(), c.val(l.getCleanVal()), c.setCaret(a), b;
                    }),
                    ...
                    (l.init = function (g) {
                        if (
                            ...
                            e.placeholder && b.attr("placeholder", e.placeholder), b.data("mask") && b.attr("autocomplete", "off"), (g = 0);
            ...
            var f = function () {
                    var b = a(this),
                        d = {},
                        e = b.attr("data-mask");
                    if ((b.attr("data-mask-reverse") && (d.reverse = !0), b.attr("data-mask-clearifnotmatch") && (d.clearIfNotMatch = !0), "true" === b.attr("data-mask-selectonfocus") && (d.selectOnFocus = !0), p(b, e, d)))
                ...
                k = function (a) {
                    var b = document.createElement("div"),
                        e = (a = "on" + a) in b;
                    return e || (b.setAttribute(a, "return;"), (e = "function" == typeof b[a])), e;
                };
            (a.fn.mask = function (b, d) {
                ...
                (a.applyDataMask = function (b) {
                    ((b = b || a.jMaskGlobals.maskElements) instanceof a ? b : a(b)).filter(a.jMaskGlobals.dataMaskAttr).each(f);
                }),
                (k = {
                ...
                (k = a.jMaskGlobals = a.extend(!0, {}, k, a.jMaskGlobals)).dataMask && a.applyDataMask(),
        ...
        a.extend(a.fn, {
            ...
            rules: function (b, c) {
                ...
                if (null != j && (!j.form && k && ((j.form = this.closest("form")[0]), (j.name = this.attr("name"))), null != j.form)) {
                    ...
                    return (
                        (g = a.validator.normalizeRules(a.extend({}, a.validator.classRules(j), a.validator.attributeRules(j), a.validator.dataRules(j), a.validator.staticRules(j)), j)).required &&
                            ((h = g.required), delete g.required, (g = a.extend({ required: h }, g))),
            ...
            a.extend(a.validator, {
                ...
                prototype: {
                    ...
                    elements: function () {
                        ...
                        return a(this.currentForm)
                            ...
                            .filter(function () {
                                ...
                                return (
                                    !d && b.settings.debug && window.console, e && ((this.form = a(this).closest("form")[0]), (this.name = d)), !(this.form !== b.currentForm || d in c || !b.objectLength(a(this).rules()) || ((c[d] = !0), 0))
                                );
                            });
                    },
                    clean: function (b) {
                    ...
                    check: function (b) {
                        ...
                        for (d in ("function" == typeof g.normalizer ? (f = g.normalizer) : "function" == typeof this.settings.normalizer && (f = this.settings.normalizer), f && ((j = f.call(b, j)), delete g.normalizer), g)) {
                            ...
                            try {
                                ...
                                throw (this.settings.debug && window.console, k instanceof TypeError && (k.message += ".  Exception occurred when checking element " + b.id + ", check the '" + e.method + "' method."), k);
                            }
                        }
                    ...
                    showLabel: function (b, c) {
                        ...
                        h.length
                            ...
                            : ((d = h = a("<" + this.settings.errorElement + ">")
                                  .attr("id", i + "-error")
                ...
                methods: {
                    required: function (b, c, d) {
                        ...
                        return this.checkable(c) ? this.getLength(b, c) > 0 : null != b && b.length > 0;
                    },
                    email: function (a, b) {
                    ...
                    date: (function () {
                        var a = !1;
                        return function (b, c) {
                            return a || ((a = !0), this.settings.debug && window.console), this.optional(c) || !/Invalid|NaN/.test(new Date(b).toString());
                        };
                    })(),
            ...
            oe = {
                ...
                in: function (e) {
                    var t,
                        ...
                        x = b.image;
                    y.$slideEl ||
                        ((y.$slideEl = this.clickedSlide ? s(this.clickedSlide) : this.slides.eq(this.activeIndex)), (y.$imageEl = y.$slideEl.find("img, svg, canvas")), (y.$imageWrapEl = y.$imageEl.parent("." + w.containerClass))),
                        y.$imageEl &&
                            0 !== y.$imageEl.length &&
                ...
                out: function () {
                    var e = this.zoom,
                        ...
                        i = e.gesture;
                    i.$slideEl ||
                        ((i.$slideEl = this.clickedSlide ? s(this.clickedSlide) : this.slides.eq(this.activeIndex)), (i.$imageEl = i.$slideEl.find("img, svg, canvas")), (i.$imageWrapEl = i.$imageEl.parent("." + t.containerClass))),
                        i.$imageEl &&
                            0 !== i.$imageEl.length &&
                            ((e.scale = 1),
                            (e.currentScale = 1),
    ...
    $(document).ready(function () {
        $("[hiddenTextBlockBtn_JS]").on("click", function () {
            var parent = $(this).closest("[hiddenTextBlockContainer_JS]");
            parent.toggleClass("open"), parent.find("[hiddenTextBlock_JS]").slideToggle(400);
        }),
            $("body").on("click", "[youTubeVideoID]", function () {
                var videoID = $(this).attr("youTubeVideoID"),
                    width = $(".page").width();
                $('[popupID="' + videoID + '"]').hasClass("replaced")
                    ? ($(".page").css("width", width), $(".page").addClass("no-scroll"), $('[popupID="' + videoID + '"]').addClass("open"))
                    : ($('[popupID="' + videoID + '"]')
                          .find(".lds-ring")
                          .replaceWith('<iframe src="https://www.youtube.com/embed/' + videoID + '" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope" allowfullscreen></iframe>'),
                      $('[popupID="' + videoID + '"]').addClass("replaced"),
                      $(".page").css("width", width),
                      $(".page").addClass("no-scroll"),
                      $('[popupID="' + videoID + '"]').addClass("open"));
            });
    }),
    $(document).ready(function () {
        $(".partners__slider").each(function () {
            var container = $(this).find(".swiper"),
                prevBtn = $(this).find(".partners__slider-button-prev"),
                nextBtn = $(this).find(".partners__slider-button-next");
            new Swiper(container, { direction: "horizontal", slidesPerView: "auto", speed: 500, noSwiping: !0, freeMode: { enabled: !0 }, navigation: { nextEl: nextBtn, prevEl: prevBtn } });
        });
    }),
    $(document).ready(function () {
        $("[phoneMask_JS]").mask("+380 (00) 000 00 00"),
            $("[checkBox_JS]").on("click", function () {
                ($element = $(this)),
                    ($checkbox = $element.find('[type="checkbox"]')),
                    ($targerBtn = $element.closest("form").find("[agreementControl_JS]")),
                    $(this).hasClass("checked")
                        ? ($element.removeClass("checked"), $checkbox.removeAttr("checked"), $targerBtn.addClass("disabled"))
                        : ($element.addClass("checked"), $checkbox.attr("checked", "checked"), $targerBtn.removeClass("disabled"));
            });
    }),
    $(document).ready(function () {
        $("[headerMobileBtn]").on("click", function () {
            ($element = $(this)), $element.toggleClass("active"), $(".header__mobile").toggleClass("open"), $("header").toggleClass("open"), $(".page").toggleClass("no-scroll");
        }),
            $("[ancor-menu__JS]").on("click", "a", function (event) {
                var attr = $(this).attr("not-ancor__JS");
                if (void 0 !== attr && !1 !== attr);
                else {
                    mobMenuClose(), event.preventDefault();
            ...
            $(window).on("load", function () {
                $("[on-scroll-display]").each(function () {
                    var el = $(this);
                    come(el) && el.addClass("visible");
                });
            }),
        ...
        if ("" != location) {
            var offset = $(location).offset().top - 100;
            $([document.documentElement, document.body]).animate({ scrollTop: offset }, 0);
        }
        $("[formValidate_JS]").each(function () {
            $(this);
            $(this).validate({ errorClass: "validate_error", rules: { user_name: { required: !0 }, user_phone: { required: !0, minlength: 19 }, user_company: { required: !0 } }, errorPlacement: function (error, element) {} });
        });
    });
var mobMenuClose = function () {
    $("[headerMobileBtn]").removeClass("active"), $(".header__mobile").removeClass("open"), $("header").removeClass("open"), $(".page").removeClass("no-scroll");
};
function come(elem) {
...
$(document).ready(function () {
    $(window).width() < 610 &&
        $(".investment__slider").each(function () {
            var container = $(this).find(".swiper"),
                pagination = $(this).find(".investment__slider-pagination");
            new Swiper(container, { direction: "horizontal", slidesPerView: 1, speed: 500, pagination: { el: pagination } });
        });
}),
    $(document).ready(function () {
        $(".legitimacy__slider").each(function () {
            var container = $(this).find(".swiper"),
                pagination = $(this).find(".slider-pagination");
            new Swiper(container, { direction: "horizontal", slidesPerView: 1, speed: 500, loop: !0, pagination: { el: pagination }, breakpoints: { 601: { slidesPerView: 4 } } });
        });
    }),
    $(document).ready(function () {
        $("[show-all_JS]").on("click", function () {
            var el = $(this);
            el
                .closest("[show-all-container_JS]")
                .find("[show-all-item_JS]")
                .each(function () {
                    $(this).slideDown(300);
                }),
                el.slideUp(300);
            ...
            $(".news__slider").each(function () {
                var container = $(this).find(".swiper"),
                    prevBtn = $(this).find(".news__slider-button-prev"),
                    nextBtn = $(this).find(".news__slider-button-next");
                new Swiper(container, { direction: "horizontal", slidesPerView: 1, speed: 500, loop: !0, navigation: { nextEl: nextBtn, prevEl: prevBtn }, breakpoints: { 601: { slidesPerView: 3 } } });
            });
    }),
    $(document).ready(function () {
        $("body").on("click", "[popup-open]", function () {
            popupClose();
            var target = $(this).attr("popup-open");
            popupOpen(target);
        }),
            ...
            $(window).width() > 600 &&
                $(document).mousemove(function (e) {
                    "true" === localStorage.getItem("downloadPopupState") && e.pageY <= 5 && (popupOpen("download-popup"), localStorage.setItem("downloadPopupState", "false"));
                }),
            $(".download-popup form").submit(function () {
                var form = $(this);
                19 == form.find('[name="user_phone"]').val().length &&
                    $.ajax({ type: "POST", url: "", data: form.serialize() }).done(function () {
                        setTimeout(function () {
    ...
    null === localStorage.getItem("downloadPopupState") && localStorage.setItem("downloadPopupState", "true");
var popupClose = function () {
        var src = $(".popup.open").find("iframe").attr("src");
        $(".popup.open").find("iframe").attr("src", ""),
            $(".popup.open").find("iframe").attr("src", src),
            $(".popup.open").find("input").val(""),
            $(".popup .validate_error").each(function () {
                $(this).removeClass("validate_error");
            }),
            $(".page").removeClass("no-scroll"),
            $(".header__nav-container").removeAttr("style"),
            $(".popup.open").removeClass("open");
    },
    popupOpen = function (e) {
        mobMenuClose(), popupClose();
        var target = e,
            width = $(".page").width();
        $(".header__nav-container").css("width", width), $(".page").css("width", width), $(".page").addClass("no-scroll"), $('[popupID="' + target + '"]').addClass("open");
    };
$(document).ready(function () {
    $("[tabTriggerID_JS]").on("click", function () {
        var el = $(this),
            id = el.attr("tabTriggerID_JS"),
            container = el.closest("[tabContainer_JS]");
        $("[tabTriggerID_JS].active").removeClass("active"), $("[tabID_JS].visible").removeClass("visible"), el.addClass("active"), container.find('[tabID_JS="' + id + '"]').addClass("visible");
    });
}),
    $(document).ready(function () {
        $(".price__slider").each(function () {
            var container = $(this).find(".swiper"),
                prevBtn = $(this).find(".price__slider-button-prev"),
                pagination = $(this).find(".price__slider-pagination"),
                nextBtn = $(this).find(".price__slider-button-next");
            new Swiper(container, {
                ...
                breakpoints: { 601: { slidesPerView: 2, slidesPerGroup: 2 } },
            });
        });
    }),
    $(document).ready(function () {
        $(window).width() < 610 &&
            $(".product-steps__slider").each(function () {
                var container = $(this).find(".swiper");
                new Swiper(container, { direction: "horizontal", slidesPerView: 1, speed: 500, spaceBetween: 20, autoHeight: !0 });
            });
    }),
    $(document).ready(function () {
        $(".results__slider-container").each(function () {
            var container = $(this).find(".swiper"),
                prevBtn = $(this).find(".results__slider-button-prev"),
                pagination = $(this).find(".results__slider-pagination"),
                nextBtn = $(this).find(".results__slider-button-next");
            new Swiper(container, {
                direction: "horizontal",
                slidesPerView: 1,
                speed: 500,
                ...
                pagination: { el: pagination },
                navigation: { nextEl: nextBtn, prevEl: prevBtn },
                breakpoints: { 601: { autoHeight: !1, slidesPerView: 2, slidesPerGroup: 1 } },
            });
        });
    }),
    $(document).ready(function () {
        $(".reviews__video-slider").each(function () {
            var container = $(this).find(".swiper"),
                prevBtn = $(this).find(".reviews__slider-button-prev"),
                pagination = $(this).find(".reviews__slider-pagination"),
                nextBtn = $(this).find(".reviews__slider-button-next");
            new Swiper(container, { direction: "horizontal", slidesPerView: 1, speed: 500, loop: !0, pagination: { el: pagination }, navigation: { nextEl: nextBtn, prevEl: prevBtn } });
        }),
            $(".reviews__img-slider").each(function () {
                var container = $(this).find(".swiper"),
                    prevBtn = $(this).find(".reviews__slider-button-prev"),
                    pagination = $(this).find(".reviews__slider-pagination"),
                    nextBtn = $(this).find(".reviews__slider-button-next");
                new Swiper(container, {
                    ...
                    pagination: { el: pagination },
                    navigation: { nextEl: nextBtn, prevEl: prevBtn },
                    breakpoints: { 601: { slidesPerView: 2, slidesPerGroup: 1 } },
                });
            });
    }),
    $(document).ready(function () {
        $(window).width() < 610 &&
            $(".steps__slider").each(function () {
                var container = $(this).find(".swiper");
                new Swiper(container, { direction: "horizontal", slidesPerView: 1, speed: 500 });
            });
    }),
    $(document).ready(function () {
        $(".warranty__slider").each(function () {
            var container = $(this).find(".swiper"),
                prevBtn = $(this).find(".warranty__slider-button-prev"),
                pagination = $(this).find(".warranty__slider-pagination"),
                nextBtn = $(this).find(".warranty__slider-button-next");
            new Swiper(container, { direction: "horizontal", slidesPerView: 2, speed: 500, slidesPerGroup: 2, pagination: { el: pagination }, navigation: { nextEl: nextBtn, prevEl: prevBtn } });
        }),
            $(".advantages__slider").each(function () {
                var container = $(this).find(".swiper"),
                    prevBtn = $(this).find(".advantages__slider-button-prev"),
                    nextBtn = $(this).find(".advantages__slider-button-next");
                new Swiper(container, { direction: "horizontal", slidesPerView: 4, speed: 500, navigation: { nextEl: nextBtn, prevEl: prevBtn } });
            }),
            $("[lightGallerySlider]").each(function () {
                var container = $(this),
                    ID = $(this).attr("lightGallerySlider");
                container.append('<div class="hiddenLightGallery_JS" id="' + ID + '"></div>');
                var lightGalleryContainer = container.find('[id="' + ID + '"]');
                container.find(".swiper-slide img").each(function () {
                    var src = $(this).attr("src");
                    0 == lightGalleryContainer.find('[href="' + src + '"]').length && lightGalleryContainer.append('<a href="' + src + '"><img alt="" src="' + src + '" /></a>');
                }),
                    lightGallery(document.getElementById(ID), {});
            }),
            $("[lightGallerySlider] .swiper-slide img").on("click", function () {
                var container = $(this).closest("[lightGallerySlider]"),
                    src = $(this).attr("src");
                container.find('.hiddenLightGallery_JS [src="' + src + '"]').trigger("click");
            });
    }),
    $(window).scroll(function () {
        $(window).scrollTop() > 1e3 ? $("#toTop").fadeIn(300) : $("#toTop").fadeOut(300);
    }),
    $(document).ready(function () {
        $("#toTop").click(function (event) {
            return event.preventDefault(), $("html, body").animate({ scrollTop: 0 }, "slow"), !1;
        });
    }),
    $(document).ready(function () {
